...
ggsave("../graphs/participant_prop_action.pdf", width = 10, height = 5)
```
...
ggplot(img_avg, aes(x = img_type, y = m, 
  ...
  ggtitle("Proportion of trials with action image selected")
ggsave("../graphs/overall_prop_action.pdf", width = 5, height = 5)
```
