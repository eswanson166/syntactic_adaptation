...
test_data <- et_data %>% filter(target_audio_type == "novel",
                                ...
                                look_left_img == TRUE | 
                                  look_right_img == TRUE,
                                time_since_trial_start >= (start_event_time + 3200) &  time_since_trial_start <= 26300)
```
...
There is a significant main effect of condition on proportion of looks to the action image, where participants in the verb condition have a higher proportion of looks to the action image.
